    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateUserRole(UpdateUserRoleDto dto)
        {
            ...
            if (dto.Role != "admin" && dto.Role != "user")
                return BadRequest(new { message = "Geçersiz rol. 'admin' veya 'user' olmalı" });
        ...
        public async Task<IActionResult> DeleteUser(int id)
        {
            ...
            // İlk admin'i silmeyi engelle
            var isFirstUser = await _context.Users
                .OrderBy(u => u.Id)
                .FirstOrDefaultAsync();

            if (isFirstUser?.Id == id && user.Role == "admin")
                return BadRequest(new { message = "İlk admin kullanıcı silinemez" });
